...
x+1 será igual a 4093, x+2 será igual a 4094 e x+3 será 4095.

b) x for declarado como int?
x+1 será igual a 4094, x+2 será igual a 4096 e x+3 será 4098.

c) x for declarado como float?
x+1 será igual a 4096, x+2 será igual a 4100 e x+3 será 4104.

d) x for declarado como double?
x+1 será igual a 4100, x+2 será igual a 4108 e x+3 será 4116.
